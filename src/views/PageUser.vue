<template>
  <div>
         ...
         <tbody>
            <template v-for="item in fonctions">
               <tr v-bind:key="item.id">
                  ...
                  <td>
                     <a @click="showModal9(item)" class="button is-black">  
                        <strong>Modifier</strong>
                     </a>
               ...
               <modal9 v-show="isModalVisible9" :item="selectedItem9" v-if="isModalVisible9" @close="closeModal9">
   ...
   <div class="table2">
         ...
         <tbody>
            <template v-for="item in variables">
               <tr v-bind:key="item.id">
                  ...
                  <td>{{ item.description }}</td>
                  <td>
                     <a @click="showModal10(item)" class="button is-black">  
                        <strong>Modifier</strong>
                     </a>
               ...
               <modal10 v-show="isModalVisible10" :item="selectedItem10" v-if="isModalVisible10" @close="closeModal10">
    ...
    <modal8 v-show="isModalVisible8" :item="page" v-if="isModalVisible8" @close="closeModal8">
...
export default {
   ...
   methods: {
      ...
      showModal9(item) {
        ...
        this.selectedItem9 = item;
      },
      showModal10(item) {
        this.isModalVisible10 = true;
        this.selectedItem10 = item;
      },
      closeModal6(value) {
