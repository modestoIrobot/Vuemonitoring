<template>
  <div>
            ...
            <template v-for="item in widgets">
               <tr v-bind:key="item.id">
                  ...
                  <td>
                     ...
                     <a @click="showModal13(item)" class="button is-black">  
                        <strong>Modifier</strong>
                     </a>
               ...
               <modal13 v-show="isModalVisible13" :item="selectedItem13" v-if="isModalVisible13" @close="closeModal13">
   ...
   <modal11 v-show="isModalVisible11" :item="interface" v-if="isModalVisible11" @close="closeModal11">
