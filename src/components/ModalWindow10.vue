	              	...
	              	<div class="modal-body">
	                	<slot name="body">
						    ...
						    <div class="field">
						        ...
						        <div class="control">
						          <input class="input" v-model="configuration" type="text" />
						        </div>
						    </div>
						    <div class="field">
...
<script>
	...
	export default {
	    ...
	    methods: {
	      async close() {
	      	const response = await axios.put('http://localhost:8000/api/pages/'+this.$route.params.id2+'/variables/'+this.item.id, {
	            name: this.name,
	            value: this.value,
